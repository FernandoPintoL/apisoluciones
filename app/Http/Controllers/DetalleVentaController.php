...
class DetalleVentaController extends Controller
{
    ...
    public function consultar(Request $request){
        try{
            if($request->has("query")){
                $item = DetalleVenta::where('name','LIKE','%'.$request->get('query').'%')->get();
    ...
    public function create_data(array $array){
        return DetalleVenta::create($array);
    }
     ...
     */
    public function update_data(array $array, DetalleVenta $detalleVenta){
        return $detalleVenta->update($array);
    }
    public function update(UpdateDetalleVentaRequest $request, DetalleVenta $detalleVenta)
    {
        try{
            $response = $this->update_data($request->all(), $detalleVenta);
            return response()->json([
                "isRequest"=> true,
                "success" => $response,
